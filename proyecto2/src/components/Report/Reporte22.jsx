    ...
    return(
        <div id="ID_reporte" >
                <div id="ID_imagen_reporte">
                    <center><h1>GRAFICA PARA LA TASA DE MORTALIDAD EN UN CONTINENTE</h1></center>                  
                    <center><img src={contenido.img}/></center>
                </div>
                <div id="ID_reporte_contenido">
                    <center>
                    <h2>Tasa de mortalidad por coronavirus (COVID-19) en un continente.</h2>
                    <p>
                    ...
                    <br/>
                    <p>
                    Tasa de mortalidad por coronavirus (COVID-19) en un continente.:<br/>
                       {contenido.tasa}<br/>
                    </p>                        
                    <p>   
