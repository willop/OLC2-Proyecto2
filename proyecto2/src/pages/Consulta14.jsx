...
import Reporte14 from "../components/Report/Reporte14"
import {jsPDF} from 'jspdf'
import fiusac from "./IMG/logo+fiusac.png"


const Consulta14 = (props) => {
    ...
    const enviarDatos = async(event) =>{
        ...
        try {
            ...
            let respuesta = await fetch('http://34.139.88.235:4000/consulta14', configuracion)
    ...
    function descargar(){
        ...
        doc.text('Muertes según regiones de un país.',130,130 )
    ...
    function Componente(){
        if (switchComp) {
            return (
                <div>
                    <Reporte14 contenido={imagenmostrar} />                  
                </div>            
            )
        }else{
            return(
    ...
    return (
        <div id="ID_general">
            <div id="ID_consulta">
                <center><h2>Muertes según regiones de un país.</h2></center>
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Label>Ingrese la columna de las regiones</Form.Label>
                    <Form.Control name="variable1" type="text" placeholder="Ingrese la columna de las regiones"  onChange={handleuserchange}/>
