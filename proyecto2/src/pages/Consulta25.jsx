...
const Consulta25 = (props) => {
    ...
    const enviarDatos = async (event) => {
        ...
        try {
            ...
            let respuesta = await fetch('http://34.139.88.235:4000/consulta25', configuracion)
    ...
    function descargar() {
        ...
        doc.text('Predicción de casos confirmados por día', 150, 130)
    ...
    function Componente() {
        if (switchComp) {
            return (
                <div>
                    <Reporte25 contenido={imagenmostrar} />
                </div>
            )
        } else {
            return (
    ...
    return (
        <div id="ID_general">
            <div id="ID_consulta">
                <center><h2>Predicción de casos confirmados por día.</h2></center>
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Label>Ingrese el numero del dia predecir</Form.Label>
                    <Form.Control name="cant" type="text" placeholder="Ingrese el numero a predecir" onChange={handleuserchange} />
                </Form.Group>
