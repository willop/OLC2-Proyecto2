...
const Consulta16 = (props) => {
    ...
    const enviarDatos = async(event) =>{
        ...
        try {
            ...
            let respuesta = await fetch('http://localhost:4000/consulta16', configuracion)
    ...
    function descargar(){
        ...
        doc.text('Porcentaje de mujeres infectados por covid-19 en un País, Region o continente',60,130 )
    ...
    return (
        <div id="ID_general">
            <div id="ID_consulta">
                <center><h2>Porcentaje de muertes frente al total de casos en un país, región o continente. </h2></center>
