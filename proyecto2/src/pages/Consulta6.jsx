...
const Consulta6 = (props) => {
    ...
    function descargar(){
        ...
        doc.text('Análisis del número de muertes por coronavirus en un País.',130,130 )
    ...
    function Componente(){
        if (switchComp) {
            return (
                <div>
                    <Reporte6 contenido={imagenmostrar} />                  
                </div>
    ...
    return (
        <div id="ID_general">
            <div id="ID_consulta">
                <center><h2>Análisis del número de muertes por coronavirus en un País.</h2></center>
