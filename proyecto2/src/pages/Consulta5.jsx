...
import Reporte5 from "../components/Report/Reporte5"
import {jsPDF} from 'jspdf'
import fiusac from "./IMG/logo+fiusac.png"


const Consulta5 = (props) => {
    ...
    const enviarDatos = async(event) =>{
        ...
        try {
            ...
            let respuesta = await fetch('http://34.139.88.235:4000/consulta5', configuracion)
    ...
    function descargar(){
        ...
        doc.text('Predicción de mortalidad por COVID en un País.',130,130 )
    ...
    function Componente(){
        if (switchComp) {
            return (
                <div>
                    <Reporte5 contenido={imagenmostrar} />                  
                </div>
