...
import Reporte4 from "../components/Report/Reporte4"
import {jsPDF} from 'jspdf'
import fiusac from "./IMG/logo+fiusac.png"

const Consulta4 = (props) => {
    ...
    const enviarDatos = async(event) =>{
        ...
        try {
            ...
            let respuesta = await fetch('http://34.139.88.235:4000/consulta4', configuracion)
    ...
    function descargar(){
        ...
        doc.text('Predicción de mortalidad por COVID en un Departamento.',120,130 )
    ...
    function Componente(){
        if (switchComp) {
            return (
                <div>
                    <Reporte4 contenido={imagenmostrar} />                  
                </div>
        ...
        <div id="ID_general">
            <div id="ID_consulta">
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label>Ingrese la columna de los departamentos</Form.Label>
