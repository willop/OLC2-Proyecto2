...
import Reporte12 from "../components/Report/Reporte12"
import {jsPDF} from 'jspdf'
import fiusac from "./IMG/logo+fiusac.png"

const Consulta12 = (props) => {
    ...
    const enviarDatos = async(event) =>{
        ...
        try {
            ...
            let respuesta = await fetch('http://34.139.88.235:4000/consulta12', configuracion)
    ...
    function Componente(){
        if (switchComp) {
            return (
                <div>
                    <Reporte12 contenido={imagenmostrar} />                  
                </div>            
            )
        }else{
            return(
